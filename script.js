...
function arrastrarElemento(element) { //Establece 4 posiciones para posicionar en la pantalla
    let pos1 = 0,
     pos2 = 0,
     pos3 = 0,
     pos4 = 0;
...
ondblclick = (event) => {
    document.getElementById('producto1').style.zIndex = 4;
    document.getElementById('producto2').style.zIndex = 4;
    document.getElementById('producto3').style.zIndex = 4;
    document.getElementById('producto4').style.zIndex = 4;
